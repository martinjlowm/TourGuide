...
_NS.TourGuide.registerGuide("Durotar (1-12)", "The Barrens (12-15)", "Horde", () => {
  return `
...
A Rune-Inscribed Tablet |C|Shaman|
T Rune-Inscribed Tablet |C|Shaman|
...
C Burning Blade Medallion |N|Go back to the fork and take the northern path at the fork. (42.7,52.9)|
C Call of Earth (Part 1) |C|Shaman|
