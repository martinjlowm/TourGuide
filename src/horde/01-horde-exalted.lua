TourGuide:RegisterGuide('Exalted with Factions (Part 1)', 'Exalted with Factions (Part 2)', 'Horde', function()
return [[
...
-- A The Escape
-- C The Escape
-- C Miner's Fortune |N|Grind for this in the mine from Enforcers and Overseers and get 5 pages for the Samophlange quest later|
-- C Verog the Dervish
...
-- A A Husband's Revenge |N|By the cooking trainer|
-- T Rot Hide Origins |N|In the Magic Quarter|
-- A Devourer of Souls |C|Warlock|
-- T Devourer of Souls |C|Warlock|
...
-- T A Husband's Revenge
-- T Wand to Bethor |N|Magic Quarter|
-- T A Recipe For Death (Part 3) |N|The Apothecarium|
...
-- R Hillsbrad Foothills |N|Try to find a group for Shadowfang Keep when you can. There are 3 quests there with Undercity reputation. 2 available at the Sepulcher|
-- A Time To Strike |N|You get this at Southpoint Tower (20,47) as soon as you enter Hillsbrad|

-- R Tarren Mill
-- f Grab flight point
-- T Journey to Hillsbrad Foothills
-- T Journey to Tarren Mill
-- A Blood of Innocents
-- A Elixir of Suffering (Part 1)
-- T Time To Strike
-- A WANTED: Syndicate Personnel
-- A The Rescue
-- h Tarren Mill
...
-- H Tarren Mill
-- T The Rescue |T|
-- T WANTED: Syndicate Personnel |T|
-- T Elixir of Suffering (Part 1) |T|
-- A Elixir of Suffering (Part 2) |T|
-- T Blood of Innocents |T|
-- A Return to Thunder Bluff |T|
...
-- N Train new skills and abilities
-- T The Book of Ur
-- T Hearts of the Pure |C|Warlock|
...
-- A Deviate Hides
-- C Trouble at the Docks
-- C Serpentbloom
-- C Smart Drinks
-- C Leaders of the Fang
-- C Deviate Eradication
-- C Deviate Hides
-- A The Glowing Shard
...
-- C The Glowing Shard |N|Talk to Sputtervalve|
-- T Trouble at the Docks
-- T Smart Drinks
...
-- C Stolen Silver
-- C The Angry Scytheclaws
-- K Lakota'mani |O| |L|5099| |N|It's walking along the south side of the canyon|
-- A Lakota'mani |O| |U|5099|
-- C Tribes at War
-- C Consumed by Hatred
...
-- T Owatanka |O| |T|
-- T Tribes at War |T|
-- A Blood Shards of Agamaggan |T|
-- T Blood Shards of Agamaggan |T|
...
-- C Earthen Arise |N|In the Boulderslide Ravine. Probably difficult (level 20 elite)|
...
-- C The Sacred Flame (Part 1) |N|Use the phial at the moonwell (60.20, 72.90)| |U|5867|
...
-- A Amongst the Ruins
-- C Amongst the Ruins
-- A Blackfathom Villainy
-- C Blackfathom Villainy
...
-- A Homeward Bound |N|Escort starts at (16,42) if elite gets in the way, skip it|
-- C Homeward Bound
-- C Test of Endurance
...
-- -----------
-- [[
-- R Orgrimmar |N|Take the zeppelin|
-- F Desolace
-- h Shadowprey Village
...
-- T Parts of the Swarm |N|At Belgrom Rockmaul in the Valley of Honor (75,34)| |Z|Orgrimmar| |T|
