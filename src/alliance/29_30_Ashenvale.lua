...
A The Missing Diplomat (Part 13) |T|
F Astranaar |N|Take the boat to Auberdine then fly down|
A Kayneth Stillwind |T|
A A Helping Hand |T| |N|From Vindicator Palanaar (34.93, 49.70), she probably won't have a ! over her head.|
h Astranaar |T|
...
T Vile Satyr! Dryads in Danger! |N|To the west of Forest Song in Xavian (78,45)|
A The Branch of Cenarius

C The Branch of Cenarius |N|Kill Geltharis behind the camp (78,42)|
...
C Agents of Destruction |N|South of Forest Song in Warsong Lumber Camp (88,54).  Overseer Gorthak is in the small building southwest of the big building (88.86, 59.51)|
C A Shameful Waste
C Reclaiming Felfire Hill |N|Southwest at Felfire Hill (81,67)|
...
C Fallen Sky Lake |N|Kill the Shadethicket Oracle at Fallen Sky Lake to the southwest past the road (66.65, 82.16)|
...
C The Howling Vale |N|Path starts just north of the box for "Raene's Cleansing" (54.0, 32.5).  Head thru the cave, find the tome on a table near the shrine (50.54, 39.07)|
...
C Never Again! |N|South at Demon Fall canyon.  Gorgannon is east up the main path (90.0, 76.8).  Diathorus is west past the monument in a cave on Demon Fall Ridge (78.01, 83.66).  Small glowing monuments mark the path up.  Both demons call for help, so make sure to clear the area around them.|
C Destroy the Legion |N|Skip this quest if you can't get all the lashers, they seem to have a very low spawn rate.|
T Never Again! |T| |N|Back in Forest Song|
