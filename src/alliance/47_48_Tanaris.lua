...
T The Sunken Temple |N|South of town at the Broken Pillar (52.72, 45.92)|
A The Stone Circle
A Gahz'ridian

U Put on the helmet |U|9978|
C The Dunemaul Compound |N|Kill Gor'marok in a small cave at the Dunemaul Compound (41.48, 57.81), then head to the ruins (47,66).  Collect stuff for "Gahz'ridian" anytime it shows up on the minimap.|
...
T An Orphan Looking For a Home |NODEBUG| |N|Up at the raceway in Shimmering Flats (78.38, 74.68)| |Z|Thousand Needles|
...
C Sprinkle's Secret Ingredient |N|At the bottom of a lake to the east near the Altar of Zul (40,59)| |Z|The Hinterlands|
C Food for Baby |N|Kill stealth wolves to the east|
