...
C Egg Hunt |QID|868|
C Betrayal from Within (Part 1) |QID|???|
C Weapons of Choice |QID|893|
A Gann's Reclamation |QID|843|
C Gann's Reclamation |QID|843|
T Gann's Reclamation |QID|843|
A Revenge of Gann (Part 1) |QID|???|

H Camp Taurajo
T Weapons of Choice |T| |QID|893|
T Betrayal from Within (Part 1) |T| |QID|???|
A Betrayal from Within (Part 2) |T| |QID|???|

F The Crossroads
T Betrayal from Within (Part 2) |T| |QID|???|
...
T Further Instructions (Part 1) |N|Down in Ratchet| |T| |QID|???|
A Further Instructions (Part 2) |T| |QID|???|
