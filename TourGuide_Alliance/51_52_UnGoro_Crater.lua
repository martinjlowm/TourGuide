...
C Muigin and Larion |N|Kill lasher around the camp area.  Also kill any diemetradons or pterrordaxes you come across|
...
C The Bait for Lar'korwi |U|11570| |N|Use the pheromone mixture, kill him!|
...
C Expedition Salvation |N|At camp to the west (38.5, 66.0).  Beware of the elite Stegodons.|
C The Western Pylon |N|Up the hill, west of the camp (23.8, 59.1)|
A Finding the Source |N|From a goblin near the hot springs (30.9, 50.4)|

C Roll the Bones |N|Scattered all over the west half of the zone and drop from diemetradons.  Kill pterrordaxes over here too.  There is usually a good stash of bones at a threshadorn carcass to the southwest of the camp (31.27, 77.43).|
...
C Finding the Source |N|At the volcano in the center of the zone.  Use the thermometer at the "Hot Spot" at the top of the mountain (49.75, 45.78).| |U|12472|
