...
T Encrypted Rune |C|Rogue| |R|Dwarf|
T Etched Rune |C|Hunter| |R|Dwarf|
T Hallowed Rune |C|Priest| |R|Dwarf|
T Simple Rune |C|Warrior| |R|Dwarf|
T Consecrated Rune |C|Paladin| |R|Dwarf|
...
T Bitter Rivals |N|Give the Thunder Ale to Jarven downstairs, then talk to the barrel.|
A Return to Marleth
...
C Vejrek |N|(27.7, 57.7)| |C|Warrior|
T Vejrek |C|Warrior|
A Tormus Deepforge |C|Warrior|
T Tormus Deepforge |C|Warrior|
A Ironband's Compound |C|Warrior|
R Dun Morogh |C|Warrior|
