...
C Stranglethorn Fever |N|Kill gorillas for a fang, take it to the troll in the cave to the north (35,60).  Defend him, the last gorrila will drop your quest item.|

T Scaring Shaky |N|Back in Booty Bay, at "Shaky" Philippe on the pier.|
...
T The Bloodsail Buccaneers (Part 4) |N|At Fleet Master Seahorn, 2nd Floor of the Inn.|
T Voodoo Dues |N|At "Sea Wolf" MacKinley (First house next to the Inn).  Skip the follow-up.|
A Stoley's Debt
